...
export const AVATAR_CARTOON: Record<string, ImageSourcePropType> = {
  ...
  tv: require('../../../assets/cartoon/avatars/tv.png'),
  cash: require('../../../assets/cartoon/avatars/cash.png'),
  headset: require('../../../assets/cartoon/avatars/headset.png'),
  balloon: require('../../../assets/cartoon/avatars/balloon.png'),
  crown: require('../../../assets/cartoon/avatars/crown.png'),
  rainbow: require('../../../assets/cartoon/avatars/rainbow.png'),
  dinosaur: require('../../../assets/cartoon/avatars/dinosaur.png'),
  unicorn: require('../../../assets/cartoon/avatars/unicorn.png'),
  gift: require('../../../assets/cartoon/gift.png'),
  'color-palette': require('../../../assets/cartoon/avatars/brush.png'),
};
